`node main.js sourceDir finalDir -d`

`sourceDir` - путь к исходной папке; 

`finalDir` - путь к итоговой папке; 

`-d`(необязательный параметр) - необходимость удаления исходной; 
